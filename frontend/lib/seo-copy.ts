...
export const SEO_PAGES_COPY: Record<string, SEOPageData> = {
  'remover-metadados': {
    ...
    features: [
      ...
      { h3: 'Harmonização de Canal', desc: 'As grandes redes priorizam fotos com aspect humano e limpo. Purificar esses dados e re-estruturar metadados textuais otimiza a aparência da mídia.' },
