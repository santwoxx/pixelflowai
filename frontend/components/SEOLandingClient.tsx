  ...
  return (
    <div className="bg-[#020617] text-slate-100 min-h-screen relative selection:bg-amber-400 selection:text-slate-950 pb-20">
      ...
      <div className="mx-auto max-w-6xl px-6 pt-10 relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between min-h-[340px]">
              ...
              {!file ? (
                ...
                <div className="flex-grow flex flex-col bg-slate-950/50 rounded-xl p-4 border border-slate-800 relative">
                  ...
                  {/* Display preview */}
                  <div className="flex-grow flex items-center justify-center relative rounded overflow-hidden max-h-[220px] bg-slate-955 min-h-[180px]">
                    {previewUrl && (
                      <img 
                        src={previewUrl} 
                    ...
                    {processing && (
                      <div className="absolute inset-0 bg-slate-955/95 backdrop-blur-sm flex flex-col items-center justify-center p-4 z-20">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-slate-900 to-[#0e1630] border border-slate-800 p-8 sm:p-10 text-center relative overflow-hidden mb-20 shadow-2xl">
