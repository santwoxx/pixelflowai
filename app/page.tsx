...
export default function Home() {
  const { profile, setAuthOpen, showCheckout, setShowCheckout, refreshProfile } = useAuth();
      ...
      <main className="flex-grow">
        ...
        <section className="py-24 relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="flex flex-col bg-slate-900/30 border border-slate-800/80 p-6 rounded-2xl hover:border-amber-500/20 transition-all duration-300">
